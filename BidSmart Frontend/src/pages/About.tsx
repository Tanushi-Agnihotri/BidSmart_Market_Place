      ...
      <div className="container relative mx-auto px-4 py-12">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap gap-3 animate-float-up delay-500" style={{ animationFillMode: 'both' }}>
            ...
            <Link to="/register" className="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/5 backdrop-blur-md px-8 py-4 text-lg font-medium text-white transition-all hover:bg-white/10 hover:border-white/30">
              Create Account
            </Link>
          </div>
        </div>
